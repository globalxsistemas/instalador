...
```bash
sudo apt install -y git && git clone https://github.com/globalxsistemas/instalador install && sudo chmod -R 777 ./install && cd ./install && sudo ./install_primaria
```
